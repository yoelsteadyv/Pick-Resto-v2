...
function showDetail() {
  Swal.fire({
    ...
    html: `
      ...
      <img class="image" src="${this.parentElement.parentElement.querySelector('.thumb-res').src}" alt="gambar ${this.parentElement.querySelector('.title-res').textContent}" crossorigin="anonymous" style="width: 100%; margin-bottom: 10px;">
      <div class="info">
